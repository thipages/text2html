...
let sources= [
    `start|A^Here I am^| and |B^Here I stick^|end`,
    `start|A^Here I am|B^embedded^|^|end`,
    `start|list^\nitem1\nitem2\n^|end`,
];
let excepted= [
    `start<span style="color:red">Here I am</span> and <span style="color:yellow">Here I stick</span>end`,
